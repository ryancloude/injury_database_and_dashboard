...
with DAG(
    dag_id = 'update_transaction_daily',
    description='Updating transactions table in baseball db',
    schedule='0 6 * * *',
    ...
    task_id='run_update_transactions',
    bash_command='python /opt/airflow/scripts/update_transactions.py',
