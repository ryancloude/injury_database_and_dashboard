...
with DAG(
    dag_id = 'update_bronze_games_daily',
    description='Updating bronze games table in baseball db',
    schedule='0 6 * 2-11 *',
    ...
    task_id='update_bronze_players',
    bash_command='python /opt/airflow/scripts/database/bronze/bronze_games.py',
